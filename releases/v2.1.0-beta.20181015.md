...
- Columns that are part of a table's [`PRIMARY KEY`](../v2.1/primary-key.html) can no longer be specified as [`COVERING` columns](../v2.1/create-index.html#covering-columns) in secondary indexes on the table. [#31032][#31032]
